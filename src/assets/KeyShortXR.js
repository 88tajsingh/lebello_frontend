...
window.keyshotXR = function (
  ...
  function P(a, f, b) {
    a.removeEventListener
      ...
      : a.detachEvent && (a.detachEvent('on' + f, a['e' + f + b]), (a['e' + f + b] = t))
  }
  function k(a, f, b) {
    a.addEventListener
  ...
  function ja(d) {
    ...
    1 == b.length &&
      b[0] &&
      ((j.a.x = b[0].pageX), (j.a.y = b[0].pageY), 0 <= j.d && pa(j.a.x, j.a.y))
      ...
      (1 == j.d
        ...
        : 0.01 < i.L &&
          ...
          0.055 > i.b.x * i.b.x + i.b.y * i.b.y &&
            ((i.b.x = 0), (i.b.y = 0), (q.b.x = 0), (q.b.y = 0), (q.a.x = i.a.x), (q.a.y = i.a.y)),
  ...
  this.Ca = function () {
    if (e.J) {
      ...
      if (-1 != a.F[d] && (W.setAttribute('src', a.D[d]), W.complete || (a.ja = p), void 0 !== r))
        if (((d = a.ia[d]), !d && void 0 == r[d])) {
          ...
          document.getElementById('xr_hotspot') &&
            ((b = document.getElementById('xr_hotspot')), document.body.removeChild(b)),
            ...
            void 0 !== r[d].options &&
              (r[d].options.fontSize && (b.style.fontSize = r[d].options.fontSize),
    ...
    1 == j.d
      ...
      : 2 == j.d
        ? ((E.start.x = a.cursor.x),
          ...
          (a.e /= c.u),
          (a.f /= c.u))
        : 3 == j.d && ((E.start.x = a.cursor.x), (E.start.y = a.cursor.y), (c.m.x = 0), (c.m.y = 0))
  }
  this.Ha = function (b) {
  ...
  if (document.createElement('canvas').getContext) {
    ...
    for (D = 0; D < w.length; D++)
      'undefined' != typeof document.documentElement.style[w[D] + 'Transform'] &&
