  ...
  <div class="overflow-hidden">
            ...
            <div class="px-11 my-10">
              ...
              <div class="">
                <p class="text-[16px] mx-12 font-graphikLight text-[#666 ]">
                  ...
                  customization solutions tailored towards your design requirements. The B Chair
                  comes in a low and high-back model.
                </p>
              </div>
              <div
                class="mt-10 flex hover:text-green"
                :class="{ 'text-green': addiVisible }"
                @click="HandleAdditionalInfo()"
                @mouseenter="setAddiColor('#4dc45c')"
                @mouseleave="setAddiColor('#333')"
              >
                <span rel="off" class="ml-12 uppercase font-graphikMedium text-[13px]" v-scroll="0"
    ...
    <transition>
      <div
        id="app"
        v-show="isVisible"
        :class="{ 'ease-in-out': isVisible }"
        class="container-fluid bg-[#d8d8d8] p-0"
      >
        ...
        <div class="transition-opacity ease-in-out duration-300">
          <div class="py-10 m-0 relative px-14 w-1/2 font-light text-left text-white bg-green">
            <p id="directTO" class="font-graphikLight text-[27px] leading-9">
              Crafted from our exclusive Ropetek® materials and woven in one of our signature
              styles.
            </p>
    ...
    <div class="flex justify-between uppercase py-4">
      <div class="ml-16 flex self-center">
        <ul
          class="flex font-graphikMedium text-[14px] text-green hover:text-blue"
        ...
        <ul
          class="flex font-medium text-green hover:text-blue"
      ...
      <ul class="flex justify-center space-x-1 pr-20">
        <li>
          <a
            href="https://www.facebook.com/share.php?u=https://lebello.com/products/b-chair-1-2/&title=B Chair"
            target="_blank"
            title="Facebook"
