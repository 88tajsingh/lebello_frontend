<template>
  <div class="overflow-x-hidden">
    ...
    <Slider :images="landingPageData.home_slider" imageKeyName="featured_image_data" :navColor="'white'"
      :openClass="computedOpenClass" :closeClass="computedCloseClass" height="100vh" :closeSidebar="closeSidebar" @updateNavColor="updateNavColor"
      ...
      <template #sidebar>
        <div class="z-50 pt-10 px-6 md:pl-16 md:pr-32 ">
          ...
          <div class="">
            ...
            <div class="text-[#333]">
              <h3 class="text-[19px] font-graphikMedium pb-3 pt-8  border-b border-[#33333357] uppercase">Highlights
              </h3>
            </div>
          ...
          <div class="flex">
            ...
            <div class="w-5/12 bg-[rgb(220,214,205)] px-8 pt-10">
              ...
              <p class="font-graphikLight pb-16 text-[15px]">
                Simple yet timeless, our new collection for the 2022 Forever Summer Collection ® is Inspired by Nature
                with
                warm and vibrant natural colors and materials.
              </p>
