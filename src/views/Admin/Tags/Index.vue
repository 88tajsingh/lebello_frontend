<template>
    ...
    <div class="flex content-between justify-between px-1 mb-2">
      ...
      <div class="flex">
        ...
        <Button @click="() => {router.push({ name:'Tags-form'}); store.dispatch('clearEditData');}" class="px-2 py-2">Add Tags</Button>  
      </div>
    </div>
      ...
      :rows="rows" :columns="tagsCols" :loading="getLoading" :totalRows="totalRows" :isServerMode="true" :pageSize="10" :search="search" @change="changePages">
        ...
        <template #actions="data">
          <div class="flex gap-3">
            <div @click="() =>{ store.dispatch('setEdit', data.value); router.push({ name:'Tags-form'} ); } " id="edit svg">
