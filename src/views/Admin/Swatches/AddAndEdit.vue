    ...
    <form @submit.prevent="handleSubmit" class="mb-5 m-5">
        <div class="grid grid-cols-12 gap-4 mt-5 ">
            <div class="col-span-8">
                <div>
                    <TextInput type="text" class="block mr-2 h-[40px] w-full" :class="{ 'border-red': errors.title }"
                        placeholder="Add title" v-model="form.title" :errMessage="errors.title"
                        @update:model="$clearError(errors, 'title')" />
                </div>
                <div class="mt-5">
                            ...
                            <Button type="">
                                <span class="flex">
                                    <svg class="text-black hover:text-white" fill="text-textColor2" width="20px"
                                        height="20px" viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="mt-5">
                    <Accordion :open="true" header="Seo Options">
                        ...
                        <div class=" px-6 mt-2 items-center text-gray-600 text-sm">
                            <TextInput id=" " type="text" class="block w-[180px] mr-2 h-[33px]" v-model="form.seo_title"
                                placeholder="Title Tag" label="Title Tag" :message="errors.seo_title" />
                        ...
                        <div class="mx-6 mt-3 items-center text-gray-600 text-sm">
                            <TextInput id=" " :isTextarea="true" :='4' type="text"
                ...
                <div class="mt-5">
                    <Accordion open="false" header="Slug">
                        <TextInput id=" " :rows='4' type="text" class="block w-[180px] mr-2 h-[33px]" v-model="form.slug"
                        placeholder="Slug" label="Slug" :message="errors.slug" />
                    </Accordion>
                </div>
            </div>
            ...
            <div class="col-span-4">
                        ...
                        <div class="mt-2 px-6 flex h-auto ">
                            <div class="w-full">
                                 <div class='flex gap-1 '>
                                    <div class="border border-gray py-1 px-5" @click="togelTrue"  >
                                        mateirals
                                        </div>
                                        <div class="border border-gray py-1 px-5"  @click="togelFalse">hzasd</div>  
                                 </div>
                                 <div v-if="tabcheck">
                                    
                                    <Checkbox :nexted=true :data="materialTree" @checked-items="handleCheckedItems" />
                                 </div>
                ...
                <div class="mt-3 ">
                    <Accordion :open="true" header="Featured image">
                        <div class="my-5 px-6  h-auto ">
                            <!-- <LinkBtn :click="route('add.swatches')" class="text-sm border-none underline "
                                :buttonText="'set Featured image'" /> -->
                            <InputLabel for="Featured_image" value="Featured_image" />
                            <ImageUpload2 @file-selected="handleFeaturedImg"
...
const tabs = ref([
            ...
            {
                id: 237, name: "Table Surfaces", subList: [
                    { id: 176, name: "PC Colors" },
                    { id: 197, name: "Peel Fibers" },
                    { id: 211, name: "Group 1 Fabrics" },
                ]
            },
            {
                id: 237, name: "Table Surfaces", subList: [
    ...
    },
    {
        header: "Most Use",
        content: [
            { id: 237, name: "Table Surfaces" },
            { id: 176, name: "PC Colors" },
            { id: 197, name: "Peel Fibers" },
            { id: 211, name: "Group 1 Fabrics" },
            { id: 218, name: "Group 2 Fabrics" },
            { id: 444, name: "Sunbrella / Custom" },
            { id: 437, name: "Sunproof" },
            { id: 433, name: "Surface Tex" },
            { id: 374, name: "Teak Surfaces" },
            { id: 419, name: "Knittex" }
        ],
    },
]);
...
const handleFeaturedImg = (file) => {
    console.log('Selected file:', file);
    form.featured_image = file;
}
const handleImage_Overlay = (file) => {
    console.log('Selected file:', file);
    form.image_overlay = file;
}


const form = ref({...props.swatches});
