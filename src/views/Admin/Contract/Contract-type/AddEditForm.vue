<template>
    <DefaultCard :cardTitle="form.id ? `Edit Contract Type` : `Add Contract Type`">
      ...
      :deleteService="ContractServices.deleteContractType" masterKey="master_contract_type_id"
      :masterDeleteService="ContractServices.deleteMasterContractType" routeTo="contract-type"></DomainComponent>
        ...
        <form @submit.prevent="handleSubmit">
            <div class="p-6.5 grid grid-cols-2 gap-6">
                <div class="flex flex-col ">
                    ...
                    @update:checkValue="value => checkedFields.contract_name = value" />
                ...
                <div class="flex flex-col ">
                    ...
                    <Select :options="contractTypeTreeListData" :defaultZero='true' showfield="contract_name" class="w-full" valueField="id"
                        ...
                        :errorClass="selectError" @update:modelValue="clearError('parent_contract_type')"
                        errMessage="Should not be own parent"
                        />
                    <p class="text-sm text-[#646970] text-[11.5px]">
