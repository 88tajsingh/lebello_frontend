    ...
    <form @submit.prevent="handleSubmit">{{ form }}
        <div class="p-6.5 grid grid-cols-3 gap-2">
            <div class="flex flex-col ">
                ...
                <Select :options="props.allCurrencies" showfield="currency" class="w-full" valueField="code"
                    label="Select Country" v-model="form.from_currency" />
            </div>
            <div class="flex flex-col ">
                <InputLabel for="Status" value="To Country" />
                <Select :options="props.allCurrencies" showfield="currency" class="w-full" valueField="code"
                    label="Select Country" v-model="form.to_currency" />
            ...
            <div class="flex flex-col ">
                <InputLabel for="Country" value="From Country" />
                <Select disabled :options="props.allCurrencies" showfield="currency" class="w-full" valueField="code"
                    label="Select Country" v-model="form.to_currency" />
            </div>
            <div class="flex flex-col ">
                <InputLabel for="Status" value="To Country" />
            ...
            <div class="flex flex-col">
                <TextInput type="text" disabled label="Exchnage rate *" class="block mr-2 h-[40px] w-full"
