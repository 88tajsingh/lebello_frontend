<template>
                ...
                <div class="col-span-8">
                    ...
                    <div class="mt-5">
                        <Accordion :open="true" header="Slider Text">
                            <div class="px-5 pt-2">
                                <div class="flex">
                                    <SingleCheck v-if="form.id" label="" v-model="checkedFields.slider_text">
                                    </SingleCheck>
                            ...
                            <div class="mt-2 px-6  h-auto">
                                ...
                                <div class="mt-2  flex h-auto">
                                    <Select :options="sliderMenu" showfield="name" class="w-full" :defaultZero='true'
                                        ...
                                        :hasCheckBox="checkBoxFlag"
                                        @update:checkValue="(value) => { checkedFields.slider_menu_color = value }" />
                                </div>
                                <div class="mt-3  flex h-auto">
                                    <div class=" flex  w-full h-auto ">
                                        <SingleCheck v-if="form.id" label=""
                                            v-model="checkedFields.slider_video_source">
                                        </SingleCheck>
    ...
    <popupModal modalTitle="Media Library" customClasses="w-[1000px] h-[570px]"
        v-model:isOpen="imageData.slider_video_source.isOpen">
        <GetLibrary btnName="select File" :getFlag="true" :selected="imageData.slider_video_source.images"
            :singleFile="true" :closeModal="() => { imageData.slider_video_source.isOpen = false }"
            :selectedFiles="handleVideoFiles" />
    </popupModal>
