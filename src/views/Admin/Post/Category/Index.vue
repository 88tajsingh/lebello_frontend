<template>
    ...
    <div class="flex content-between justify-between px-1 mb-2">
      ...
      <div class="flex">
        ...
        <Button @click="() => {router.push({ name: 'Post-category-form'}); store.dispatch('clearEditData'); }" class="px-2 py-2">Add Post Category</Button>  
      </div>
    </div>
      ...
      :rows="rows" :columns="productTypeCols" :loading="getLoading" :totalRows="totalRows" :isServerMode="true" :pageSize="10" :search="search" @change="changePages">
        ...
        <template #actions="data">
          <div class="flex gap-3">
            <div @click="() =>{router.push({ name: 'Post-category-form'}); store.dispatch('setEdit', data.value);  }" id="edit svg">
