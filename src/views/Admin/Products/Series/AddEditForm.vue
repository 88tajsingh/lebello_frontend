<template>
    <DefaultCard  :cardTitle="form.id ? `Edit Product Series ` : `Add Product Series`">
      <DomainComponent @customChange="(id)=>form.domain_id = id"
          :deleteService="ProductServices.deleteProductSeries" masterKey="master_product_series_id"
          :masterDeleteService="ProductServices.deleteMasterProductSeries" routeTo="product-series"
          ></DomainComponent>
        <template v-if="form.id" v-slot:header>
            <MasterSlugForm
        :form="form"
        @update-slug="()=>fetchProductSeriesData()"
        ...
        <div class="p-6.5 grid grid-cols-2 gap-6">
            ...
            <div class="flex flex-col ">
                <TextInput type="text" class="block mr-2 h-[40px] w-full" 
                    placeholder="" v-model="form.slug" label="Slug (Read Only)" disabled="true" />
                <p class="text-sm text-[#646970] text-[11.5px]">
            ...
            <div class="flex flex-col w-full">
                ...
                label="Label"
                    ...
                    v-model="form.label" 
                    :hasCheckBox="checkBoxFlag"
            @update:checkValue="value => checkedFields.label = value"
                    />
            </div>
            <div class="flex flex-col w-full">
                <TextInput type="text" class="block mr-2  w-full"
                label="Menu Label"
                    ...
                    :hasCheckBox="checkBoxFlag"
            @update:checkValue="value => checkedFields.menu_label = value" 
                    />
            ...
            <div class="flex flex-col w-full ">
                                <singleCheck id="FeaturedOption" label="Show in New Menu" v-model:modelValue="form.show_in_menu"></singleCheck>
                                <singleCheck id="FeaturedOption" label="Show in Collection 19 Menu" v-model:modelValue="form.show_in_yearly_collection"></singleCheck>
                              </div>
                              <div class="flex flex-col w-full  ">
