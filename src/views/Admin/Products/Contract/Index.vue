<template>
  ...
  <div class="flex content-between justify-between px-1 mb-2">
    ...
    <div class="flex">
      ...
      <Button v-if="permissions.write"
        @click="() => { router.push({ name: 'Product-contract-from' }); store.dispatch('clearEditData'); }"
        class="px-2 py-2">Add Product Contract</Button>
    </div>
  </div>
  <div class="bg-white rounded-[20px]">
    <vue3-datatable class="next-prev-pagination" ref="datatable" skin="bh-table-striped bh-table-hover "
      :hasCheckbox="true" :cloneHeaderInFooter="true" :stickyHeader="false" :rows="rows" :columns="productContractCols"
  ...
  <DeleteModal v-model:isOpen="deleteModalIsOpen" :modalTitle="'Delete Product Contract'"
