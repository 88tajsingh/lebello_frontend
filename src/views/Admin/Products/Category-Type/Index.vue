<template>
    ...
    <div class="flex content-between justify-between px-1 mb-2">
      ...
      <div class="flex">
        ...
        <Button @click="() => {router.push('/product-category-type-add') }" class="px-2 py-2">Add Product Category</Button>  
      </div>
    </div>
      ...
      :rows="rows" :columns="productCategoryTypeCols" :loading="getLoading" :totalRows="totalRows" :isServerMode="true" :pageSize="10" :search="search" @change="changePages">
        ...
        <template #actions="data">
          <div class="flex gap-3">
            <div @click="() =>router.push({ name:'Product-category-type-edit',params: { id: data.value.id }}) " id="edit svg">
