...
import {getDomins,getProductContractTree,getProductSeriesTree,getProductContractTypeTree,MaterialTreeList, getProductTypeTree} from '@/helper/Apis'
...
const getProductCategoryTypeTreeList = async (payload) => {
    loading.value = true
    treeData.value = await getProductContractTypeTree(payload)
    loading.value = false
}
