<template>
  ...
  <div class="flex items-center justify-end gap-2">
    ...
    <div class="w-52">
      <InputLabel class="ml-1">Select Taxonomy</InputLabel>
      <Select
        :options="designerTaxonomy"
        showfield="name"
        class="w-full"
        valueField="value"
  ...
  <Button
    ...
    bg_th_color=" mt-5 text-white bg-[#2271B1] hover:bg-[#0a4b78]"
    class="text-sm ml-auto px-3 py-1"
  >
    Save
  </Button>
