<template>
  <div ref="closeMenu" class="relative">
    <div 
      ...
      class="sidenav borderborder-red bg-[#ededed] pb-2 z-50 absolute top-7 transition-all duration-1000 ease-in-out"
    >
      <slot></slot>
    </div>
    <span
      v-if="!isOpen"
      @click="toggleSidebar"
      class="text-9xl bg-transparent sticky top-5 z-[9999]"
    >
